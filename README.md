...
codex plugin marketplace add jgangini/codex-plugin-oci-architecture-diagram@v0.4.1
...
tag to `main` or from `v0.4.1` to a newer release tag.
...
white margins and uses the slide's neutral gray background.
